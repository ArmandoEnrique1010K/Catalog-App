...
| GET /products/search?                                  | Obtener una lista de productos habilitados filtrados por los filtros: name, idCategory, idBrands, offer y featureValues. FALTA investigar una forma de ordenar los productos. Adicionalmente, solamente se van a mostrar todos los productos que cuentan con su ficha tecnica. | Sin restricción | ✅⚠️    |
...
| PUT /products/update/{id}                              | Actualizar un producto existente, incluyendo si se va a reemplazar o conservar la imagen original y la ficha tecnica.                                                                                                                                                          | ADMIN           | ❌      |
...
| POST /product/{id}/feature/tech-sheet/test2            | Endpoint experimental para guardar la ficha tecnica de un producto "mediante un DTO"                                                                                                                                                                                           |                 | ⚠️⚠️   |

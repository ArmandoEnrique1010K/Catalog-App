...
public class ProductServiceImpl implements ProductService {
    ...
    // TODO: REPARAR ESTO
    // @Override
    // public Optional<ProductDetailTechSheetDto> updateWithTechSheet(ProductRequest
    // product, MultipartFile file,
    // Long id) {
    ...
    // // TODO: CORREGIR ESTO: SOLAMENTE DEBE HACER UN SAVE
    // // Primero guardamos el producto sin la imagen
    // // Product updatedProduct = productRepository.save(productDb);
    ...
    // productDb.setProductImage(image);
    // result = productRepository.save(productDb); // Segunda actualización con
    // imagen
    // } else {
    // System.out.println("NO SE SUBIÓ UNA NUEVA IMAGEN, SE MANTIENE LA ACTUAL.");
    // }
    ...
    // // 🔹 Verificar que no exista un registro duplicado en ProductFeature
    // boolean exists = productFeatureRepository.findByProductAndFeatureValue(
    // result, featureValue)
    // .isPresent();
    // if (!exists) {
    // ProductFeature productFeature = new ProductFeature();
    // productFeature.setProduct(result); // ✅ Producto ya guardado
    // productFeature.setFeature(feature); // ✅ Feature ya guardado
    // productFeature.setFeatureValue(featureValue); // ✅ FeatureValue ya guardado
    // productFeatureRepository.save(productFeature);
    // }
    ...
    // return Optional.ofNullable(productDetailTechSheetDtoMapper.toDto(result));
    // }
